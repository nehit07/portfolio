...
const CATEGORIES = [
    ...
    },
    {
        ...
        label: "NLP / ML",
        skills: [
            { name: "TensorFlow / PyTorch / Keras", level: 82 },
            { name: "Transformers (HuggingFace)", level: 78 },
            { name: "BERT / Fine-tuning", level: 75 },
            { name: "CNN / GAN Architectures", level: 80 },
            { name: "spaCy / NLTK", level: 80 },
        ],
        accent: "#10b981",
    },
    {
